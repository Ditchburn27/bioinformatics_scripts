...
# Save trained model
filename = '2023-12-12_PN_logisticRegression_ELN_stage_id_classifier'
pickle.dump(best_model, open(filename, 'wb'))

# Confusion matrix figure
with rc_context({'figure.figsize':{5,5}}):
    ax = ConfusionMatrixDisplay.from_predictions(y_test, y_pred)
    plt.savefig('2023-12-13_hyperparameter_tuned_LReln_classifier_confusion_matrix.png', format='png')
